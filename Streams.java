...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void DerBufferedFileWriter() {
		// Try-Catch: Es gibt keinen Parameter, sondern eine offene geschweifte Klammer
		// Try-Resource: Dort gibt es einen parameter. Syntax: siehe unten
		try (BufferedWriter bw = new BufferedWriter(new FileWriter("C:/Users/Sefa/Desktop/DerBufferWriter.txt"))) { // nur mit einem
															
	//		FileWriter fis = new FileWriter(new BufferWriter()); darf so nicht sein !
			bw.write("Anne seni cok seviyorum!"); 
			bw.newLine();	// nur der bufferwriter kann newLine() aufrufen !  FIleWriter nicht(er nur .write()) !
			bw.write("hemde Cok !!");

		} catch (IOException e) {
			System.out.println("Die datei test.txt wurde breits erstellt!");
			e.printStackTrace();
			// catch{...... nciht mehr als eine exception)}
		}
	}
