...
public class URLExample{
	...
	public static void main(String[] args) throws IOException {
		URL myURL = null;
		try {
			myURL = new URL("http://www.sourberrygames.bplaced.net");
			// myURL = new URL("http://www.sourberrygames.bplaced.net","/index.html");
			// myURL = new URL("http","www.sourberrygames.bplaced.net","");
